...
async function printNextSteps(config) {
    ...
    common_1.log(`Add platforms using "npx cap add":\n`);
    common_1.log(`  npx cap add android`);
    common_1.log(`  npx cap add ios`);
    common_1.log(`  npx cap add electron`);
    common_1.log('');
    common_1.log(`Follow the Developer Workflow guide to get building:\n${chalk.bold(`https://capacitor.ionicframework.com/docs/basics/workflow`)}`);
}
